...
<head>
  ...
  <style>
    body {font-family: "Roboto", sans-serif;background-image: url("images/background/greybg.jpg");}
    .form1 {font-size: 30px;color: #ffffff;border-radius: 10px;font-family: inherit;font-size: inherit; background-color: black;
...
<body>
  ...
  <center>
    <div class="mid">
      <p style="font-size: 40px; color: #ffffff" class="new">Registration Form 
      </p><br> <br>
      <form class="form1" action="" method="post">
      <br><p>Fullname:</p>
        <p style="text-align: center;"> <input style="border-radius:10px; font-size:20px; padding: 5px" name="name" type="text" require="required"></p>
        <br><p>Username:</p>
        <p style="text-align: center;"><input style="border-radius:10px; font-size:20px; padding: 5px" name="user" type="text" required="required"></p>
        <br><p>E-mail
          Addrress:</p>
        <p style="text-align: center;"><input style="border-radius:10px; font-size:20px; padding: 5px" name="email" type="email" required="required"></p>
        <br><p>Password</p>
        <p style="text-align: center;"><input style="border-radius:10px; font-size:20px; padding: 5px" name="pass" type="password" required="required"></p>
        <br><p>Re-typePassword</p>
        <p style="text-align: center;"><input style="border-radius:10px; font-size:20px; padding: 5px" name="repass" type="password" required="required"></p><br>
        <p style="text-align: center;"><input style="border-radius:20px ;border:solid 2px;font-size:15px; padding: 5px" name="submits" value="Register Account" type="submit">
        </p>
