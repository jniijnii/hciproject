...
<head>
    ...
    <style>
        body {background-image: url("images/background/greybg.jpg");}
        .form1 {font-size: 40px;color: #ffffff;border-radius: 5px;font-family: inherit;font-size: inherit;font-weight: 900;
        ...
        <div class="mid">
            ...
            <form action="Account.php" method="post">
                ...
                <div class="form-group">
                    <input type="text" style="border-radius:10px; font-size:20px; padding: 5px" name="username" id="userid" size="30" required="required" />
                </div><br><br>
                <br>
                </p>
                ...
                <p>
                <div class="form-group"><input name="password" style="border-radius:10px;font-size:20px; padding: 5px" id="passid" type="password" size="30" required="required"><br>
                    <br><br><br>
                </div>
                <input style="border-radius:10px ;border:solid 2px;font-size:15px; padding: 5px" id="btton" name="submits" value="Login Account" type="submit">
                </p>
            </form>
        </div>
    </center>
